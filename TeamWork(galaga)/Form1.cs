    ...
    public partial class Form1 : Form
    {
        ...
        private void MoveDown_Tick(object sender, EventArgs e)
        {
            for (int i = 0; i < aliens.Count; i++)
            {
                ...
                if(aliens[i].Bottom > (ClientRectangle.Top + ClientRectangle.Height))
                {
        ...
        //Reseting settings at the begining of each round
        private void restart()
        {
            ...
            player.Left = ClientRectangle.Left + (ClientRectangle.Width / 2);
            ...
            //reseting alien position after each round
            for (int i = 0; i < 20; i++)
            {
                if (i % 2 == 0)
                {
